rootProject.name = "metaform-tractusx"
...
//var edcSnapshot = "0.0.1-20230416-SNAPSHOT"
var edcSnapshot = "0.0.1-SNAPSHOT"
...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            from("org.eclipse.edc:edc-versions:${edcSnapshot}")
        }

        // create version catalog for all EDC modules
        create("edcLibs") {
            version("edc", edcSnapshot)
            ...
            library("jwt-core", "org.eclipse.edc", "jwt-core").versionRef("edc")
...
include("data-plane-proxy:edr-cache-spi")
include("data-plane-proxy:edr-cache-core")
include("data-plane-proxy:data-plane-proxy-provider-spi")
include("data-plane-proxy:data-plane-proxy-consumer-api")
